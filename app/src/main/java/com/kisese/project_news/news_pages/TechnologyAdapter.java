...
public class TechnologyAdapter extends BaseAdapter{
	...
	public TechnologyAdapter(TechnologyActivity mainActivity, String[] prgmNameList, int[] prgmImages, String[] urls) {
		result=prgmNameList;
		...
		public boolean onLongClick(View v) {
			...
			builder.setItems(R.array.options, new DialogInterface.OnClickListener() {
	                        ...
	                        public void onClick(DialogInterface dialog, int id) {
	                            ...
	                            if (ur.length() > 0 && ch.length()>0) {
	                                ...
	                                if (ur.matches(urlPattern)) {
	                                	...
	                                	sharedPref = context.getSharedPreferences("tech", Context.MODE_PRIVATE);
	            	            		...
	            	            		if(ur.contains(".xml") || ur.contains(".rss")){
	                    					...
	                    					prefs.commit();	
	                    					Intent myIntentb = new Intent(context.getApplicationContext(), TechnologyActivity.class);
	           ...
	           //================================================================================================
	            		...
	            		prefs.remove(result[position]);
	            		prefs.commit();
	            		Intent myIntenta = new Intent(context.getApplicationContext(), TechnologyActivity.class);
