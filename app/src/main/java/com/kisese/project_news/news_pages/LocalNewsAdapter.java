...
public class LocalNewsAdapter extends BaseAdapter{
	...
	public LocalNewsAdapter(LocalNewsActivity mainActivity, String[] prgmNameList, int[] prgmImages, String[] urls) {
		result=prgmNameList;
		...
		public boolean onLongClick(View v) {
			...
			builder.setItems(R.array.options, new DialogInterface.OnClickListener() {
	                        ...
	                        public void onClick(DialogInterface dialog, int id) {
	                            ...
	                            if (ur.length() > 0 && ch.length()>0) {
	                                ...
	                                if (ur.matches(urlPattern)) {
	                                	...
	                                	sharedPref = context.getSharedPreferences("local", Context.MODE_PRIVATE);
	            	            		...
	            	            		if(ur.contains(".xml") || ur.contains(".rss")){
	                    					...
	                    					prefs.commit();	
	                    					Intent myIntentb = new Intent(context.getApplicationContext(), LocalNewsActivity.class);
	                	    				context.startActivity(myIntentb);
	                                 	}else{
	           ...
	           //================================================================================================
	            		...
	            		prefs.remove(result[position]);
	            		prefs.commit();
	            		Intent myIntenta = new Intent(context.getApplicationContext(), LocalNewsActivity.class);
	    				context.startActivity(myIntenta);	
	            	}
	        }
	 });
	  builder.create();
	...
	//check link for rss
		private class CheckAgain extends AsyncTask<String, Void, String>{
			...
			protected void onPostExecute(String result) {
				...
				Intent intent = new Intent(context,LocalNewsActivity.class);
