...
public class FinanceAdapter extends BaseAdapter{
	...
	public FinanceAdapter(FinanceActivity mainActivity, String[] prgmNameList, int[] prgmImages, String[] urls) {
		result=prgmNameList;
	                        ...
	                        public void onClick(DialogInterface dialog, int id) {
	                            ...
	                            if (ur.length() > 0 && ch.length()>0) {
	                                ...
	                                if (ur.matches(urlPattern)) {
	                                	...
	                                	sharedPref = context.getSharedPreferences("finance", Context.MODE_PRIVATE);
	            	            		...
	            	            		if(ur.contains(".xml") || ur.contains(".rss")){
	                    					...
	                    					prefs.commit();	
	                    					Intent myIntent = new Intent(context.getApplicationContext(), FinanceActivity.class);
	                	    				context.startActivity(myIntent);
	                                 	}else{
