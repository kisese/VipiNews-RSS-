...
public class FunnyAdapter extends BaseAdapter{
	...
	public FunnyAdapter(FunnyActivity mainActivity, String[] prgmNameList, int[] prgmImages, String[] urls) {
		result=prgmNameList;
	                        ...
	                        public void onClick(DialogInterface dialog, int id) {
	                            ...
	                            if (ur.length() > 0 && ch.length()>0) {
	                                ...
	                                if (ur.matches(urlPattern)) {
	                                	...
	                                	sharedPref = context.getSharedPreferences("funny", Context.MODE_PRIVATE);
	            	            		...
	            	            		if(ur.contains(".xml") || ur.contains(".rss")){
	                    					...
	                    					prefs.commit();	
	                    					Intent myIntent = new Intent(context.getApplicationContext(), FunnyActivity.class);
	                	    				context.startActivity(myIntent);
	                                 	}else{
	...
	//check link for rss
		private class CheckAgain extends AsyncTask<String, Void, String>{
			...
			protected void onPostExecute(String result) {
				...
				Intent intent = new Intent(context,FunnyActivity.class);
