...
public class FashionAdapter extends BaseAdapter{
	...
	public FashionAdapter(FashionActivity mainActivity, String[] prgmNameList, int[] prgmImages, String[] urls) {
		result=prgmNameList;
	                        ...
	                        public void onClick(DialogInterface dialog, int id) {
	                            ...
	                            if (ur.length() > 0 && ch.length()>0) {
	                                ...
	                                if (ur.matches(urlPattern)) {
	                                	...
	                                	sharedPref = context.getSharedPreferences("fashion", Context.MODE_PRIVATE);
	            	            		...
	            	            		if(ur.contains(".xml") || ur.contains(".rss")){
	                    					...
	                    					prefs.commit();	
	                    					Intent myIntent = new Intent(context.getApplicationContext(), FashionActivity.class);
	                	    				context.startActivity(myIntent);
	                                 	}else{
